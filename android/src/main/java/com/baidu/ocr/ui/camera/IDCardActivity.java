...
import com.ai.flutter_baidu_ocr.R;
        ...
        findViewById(R.id.id_card_front_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(CameraActivity.KEY_OUTPUT_FILE_PATH,
                        OcrFileUtil.getSaveFile(getApplication()).getAbsolutePath());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_CAMERA && resultCode == Activity.RESULT_OK) {
            if (data != null) {
                ...
                String filePath = OcrFileUtil.getSaveFile(getApplicationContext()).getAbsolutePath();
